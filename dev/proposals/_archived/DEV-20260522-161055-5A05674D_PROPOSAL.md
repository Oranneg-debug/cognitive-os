...
decomposed_into:
  ...
  - ARCH-20260522-161600-60FE0001  # Phase 1 — Governance Foundation
  - ARCH-20260522-161700-2007E0A1  # Phase 2 — Routing Automation
  - ARCH-20260522-161800-F10FE0E1  # Phase 3+4 — Workflow Execution
decomposition_note: |
  Systems Architect agent analysed this plan against the actual codebase
  (2026-05-22) and decomposed it into FOUR proposals instead of the three
  originally requested. The added Phase 0 is a pure refactor that must land
  first — without it the governance modules inherit the existing 1031-line
  dev_route.py god-class, duplicated _trigger_sync_check helper, and triplicated
  vault path literal. See each child proposal for full evaluation notes.
original_request: "Dark Maestro: Create 3 Proposals for Boardroom Review - Complete Governance and Workflow Integration Plan (full embedded content in body below)."
---
...
> **Source note**: [[Complete Governance & Workflow Integration Plan]]
...
status: proposal
---
Dark Maestro's orders: Create the 3 Proposals for Boardroom Review
# Complete Governance & Workflow Integration Plan

**Document Version**: 1.0  
**Created**: 2026-05-21  
**Status**: 3 Dev Proposals Needed for Boardroom Review  
...
Location: [`cognitive-os/proposals-20260521-GOVERNANCE-FOUNDATION.md`](cognitive-os/proposals-20260521-GOVERNANCE-FOUNDATION.md)
...
Location: [`cognitive-os/proposals-20260521-ROUTING-AUTOMATION.md`](cognitive-os/proposals-20260521-ROUTING-AUTOMATION.md)
...
Location: [`cognitive-os/proposals-20260521-WORKFLOW-EXECUTION.md`](cognitive-os/proposals-20260521-WORKFLOW-EXECUTION.md)
...
- `src_route.py` refactor — Extract routing logic, delegate phase transitions
...
3. OUTPUT ROUTING (Layer 3)
   ...
   ✓ Create: dev/proposals-20260521-XXXX_PROPOSAL.md
   ✓ Create archive: dev/.archives-20260521-XXXX_proposal_20260521-143200.json
   ✓ Log entry: dev/decisions-20260521-XXXX_log.md
...
**Linked Proposals**:
- [`DEV-20260521-GOVERNANCE-FOUNDATION.md`](cognitive-os/proposals-20260521-GOVERNANCE-FOUNDATION.md)
- [`DEV-20260521-ROUTING-AUTOMATION.md`](cognitive-os/proposals-20260521-ROUTING-AUTOMATION.md)
- [`DEV-20260521-WORKFLOW-EXECUTION.md`](cognitive-os/proposals-20260521-WORKFLOW-EXECUTION.md)
...
**Status**: 3 Dev "
origin: "Obsidian-Plugin"
source_note: "[[Complete Governance & Workflow Integration Plan]]"
---

# DEV PROPOSAL

**Proposal ID**: `DEV-20260522-161055-5A05674D`  
**Created At**: 2026-05-22 16:10:55  
**Origin**: Obsidian-Plugin
