...
- [x] **[✏️ PLANNER] A2. Extend llm_client.py with flush_vram and restore_default_role functions**
...
- [x] **[✏️ PLANNER] A3. Create patterns package and initialize PATTERN_REGISTRY**
...
- [x] **[✏️ PLANNER] A4. Refactor src/orchestrator.py to use PATTERN_REGISTRY**
...
- [x] **[✏️ PLANNER] A5. Modify src/api.py to extract PDF text before calling orchestrator.process_request**
...
- [x] **[✏️ PLANNER] B1. Update external call sites to use new pattern modules**
...
- [x] **[✏️ PLANNER] B2. Add new test for PATTERN_REGISTRY completeness**
