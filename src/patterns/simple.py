"""Simple pattern: Single LLM pass, no orchestration."""
...
def execute(req: 'PatternRequest') -> str:
    """
    Execute a simple single-LLM-pass pattern.
    
    This pattern is for straightforward tasks that don't require sequential deliberation,
    Brand Guard audits, or complex orchestration.
    ...
    # Get the simple role config (single model pass)
